...
export default function Home() {
  ...
  return (
    <Box width="100vw" height="100vh" flexDirection="column" display="flex" justifyContent="center" alignItems="center" gap={2}>
      ...
      <Box width="900px" display="flex" flexDirection="column" alignItems="center" gap={2}>
        <TextField 
          variant="outlined"
          fullWidth
          placeholder="Search items in the inventory..."
          value={searchQuery}
      ...
      <Box border="1px solid #333">
        <Box width = "900px" height="100px" bgcolor="#FFC0CB" alignItems="center" justifyContent="center" display="flex">
